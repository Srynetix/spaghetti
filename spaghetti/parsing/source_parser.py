...
from spaghetti.parsing.module_resolver import ModuleResolver
...
class SourceParser:
    ...
    def parse_files_from_path(self, root_path: Path) -> ProjectDependencies:
        ...
        for source_file_path in source_file_paths:
            ...
            logger.debug("module_imports", source_module=source_module, imports=module_imports)
